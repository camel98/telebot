...
[![GoDoc](https://godoc.org/github.com/camel98/telebot?status.svg)](https://godoc.org/github.com/camel98/telebot)
...
```bash
go get -u github.com/camel98/telebot
```
...
import (
	...
	tele "github.com/camel98/telebot"
)
...
[here](https://godoc.org/github.com/camel98/telebot#pkg-constants).
...
implementations:
```go
import "github.com/camel98/telebot/middleware"
```
...
[here](https://pkg.go.dev/github.com/camel98/telebot#Option).
